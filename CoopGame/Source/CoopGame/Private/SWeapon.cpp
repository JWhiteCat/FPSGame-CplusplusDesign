...
void ASWeapon::Fire()
{
	...
	if (MyOwner)
	{
		...
		FHitResult Hit;
		if (GetWorld()->LineTraceSingleByChannel(Hit, EyeLoction, TraceEnd, COLLSION_WEAPON, QueryParams))
		{
			//
			...
			PlayerImpactEffects(SurfaceType, Hit.ImpactPoint);
...
void ASWeapon::OnRep_HitScanTrace()
{
	...
	PlayerImpactEffects(HitScanTrace.SurfaceType, HitScanTrace.TraceTo);
}
...
void ASWeapon::PlayFireEffects(FVector TraceEnd)
{
	...
	if (MyOwner)
	{
		...
		if (PC)
		{
			PC->ClientPlayCameraShake(FireCameraSake);
		}
	}
}

void ASWeapon::PlayerImpactEffects(EPhysicalSurface SurfaceType, FVector ImpactPoint)
{
